      ...
      <section className="bg-gradient-to-br from-brand-600 to-brand-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display font-bold text-3xl sm:text-4xl mt-3">
            ...
            <div className="relative mt-6 max-w-md">
              ...
              <input
                ...
                className="w-full rounded-xl border-0 bg-white pl-11 pr-4 py-3 text-sm text-gray-900 placeholder-gray-400 outline-none focus:ring-2 focus:ring-brand-500"
              />
            </div>
          </div>
        </div>
